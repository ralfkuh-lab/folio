...
pub struct MenuLabels {
    ...
    pub edit_search_vault: &'static str,
    pub edit_ai_translate: &'static str,
    pub edit_ai_actions: &'static str,
...
const fn de() -> MenuLabels {
    MenuLabels {
        ...
        file_close: "Tab schließen",
        file_quit: "Beenden",
        edit: "Bearbeiten",
        edit_undo: "Rückgängig",
        edit_redo: "Wiederholen",
        edit_find: "Suchen…",
        edit_search_vault: "Im Vault suchen…",
        edit_ai_translate: "Mit KI übersetzen…",
        edit_ai_actions: "KI-Aktionen…",
...
const fn en() -> MenuLabels {
    MenuLabels {
        ...
        file_rename: "Rename…",
        file_export: "Export…",
        file_close: "Close Tab",
        file_quit: "Quit",
        edit: "Edit",
        edit_undo: "Undo",
        edit_redo: "Redo",
        edit_find: "Find…",
        edit_search_vault: "Search Vault…",
        edit_ai_translate: "Translate with AI…",
        edit_ai_actions: "AI Actions…",
