...
impl MenuLabels {
    ...
    pub(crate) fn empty() -> Self {
        Self {
            ...
            view_content_width: String::new(),
            view_fullscreen: String::new(),
            view_zen: String::new(),
            help: String::new(),
...
pub fn menu_labels_from_translator(tr: &Translator) -> MenuLabels {
    ...
    MenuLabels {
        ...
        view_content_width: t("menu.view.contentWidth"),
        view_fullscreen: t("menu.view.fullscreen"),
        view_zen: t("menu.view.zen"),
        help: t("menu.help"),
